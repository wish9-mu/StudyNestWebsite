...
const AvailableCourses = () => {
    ...
    const handleDuplicate = async (e) => {
        ...
        try {
            ...
            .from("courses")
            .select("*")
            .or(`course_name.eq.${formData.course_name},course_code.eq.${formData.course_code}`);
    ...
    const addCourse = async (e) => {
        ...
        if (!error) {
            try {
                ...
                else {console.error("Error adding course:", supabaseError);}
            } catch (error) {
    ...
    const deleteCourse = async (courseCode) => {
        ...
        try {
            ...
            else {console.error("Error deleting course:", supabaseError);}
        } catch (error) {
            ...
            {modalType === "delete" &&
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <button className="yes-btn" onClick={() => deleteCourse(selectedCourseID)}>Yes</button>
    ...
    return(
        <>
         <div className="course-services">
            ...
            <button onClick={() => setModalType("add")}>Add a Course</button>
            {renderAddCourseForm()}
            {renderDeleteConfirmation()}
            {!isEditable && <button onClick={() => setEditable(true)}>Edit Courses</button>}
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Course Name</th>
                            {isEditable && 
                                <th className="done-con"><button className="done-btn"
                                onClick={() => setEditable(false)}>Done</button></th>
                                }
                        </tr>
                    </thead>
                    <tbody>
